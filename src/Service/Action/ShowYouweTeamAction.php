...
class ShowYouweTeamAction implements ActionInterface
{
    /**
    ...
    /**
     * Transform YouweTeam Entity by using custom serializers
    ...
    public function process($inputParam): array
    {
        ...
        $content= $this->entitySerializerHandler->process($inputParam,'details',$normalizers);
        return $content;
    }
}
